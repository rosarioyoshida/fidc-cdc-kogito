...
- PostgreSQL para runtime; arquivos Markdown em `specs/010-javadoc-utf8-review/` para artefatos de planejamento (010-javadoc-utf8-review)
...
## Recent Changes
- 010-javadoc-utf8-review: Added Java 21 + Spring Boot 3.3.9, Spring Security, Spring HATEOAS, Spring Data JPA, Bean Validation, Flyway, Springdoc OpenAPI, Kogito 10.1.0, Log4j2, Testcontainers
